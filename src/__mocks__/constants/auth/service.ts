...
export const mockTotpData = {
    ...
    accountWithResetToken: {
        ...
        verifyToken: {
            ...
            emailOtpExpiresAt: new Date(),
            emailOtpAttempts: 0,
            forgotPasswordSecret: `validToken123:${Date.now() + 15 * 60 * 1000}:0`, // valid token with 0 attempts
            createdAt: new Date(),
            updatedAt: new Date(),
            deletedAt: null,
            createdBy: 1,
    ...
    accountWithExpiredResetToken: {
        ...
        verifyToken: {
            ...
            emailOtpExpiresAt: new Date(),
            emailOtpAttempts: 0,
            forgotPasswordSecret: `expiredToken123:${Date.now() - 10 * 60 * 1000}:0`, // expired token
            createdAt: new Date(),
            updatedAt: new Date(),
            deletedAt: null,
            createdBy: 1,
    ...
    accountWithMaxAttempts: {
        ...
        verifyToken: {
            ...
            emailOtpExpiresAt: new Date(),
            emailOtpAttempts: 0,
            forgotPasswordSecret: `validToken456:${Date.now() + 15 * 60 * 1000}:5`, // max attempts reached
            createdAt: new Date(),
            updatedAt: new Date(),
            deletedAt: null,
            createdBy: 1,
    ...
    accountWithCooldown: {
        ...
        verifyToken: {
            ...
            emailOtpExpiresAt: new Date(),
            emailOtpAttempts: 0,
            forgotPasswordSecret: `cooldownToken:${Date.now() + 15 * 60 * 1000}:0`,
            createdAt: new Date(),
            updatedAt: new Date(),
            deletedAt: null,
            createdBy: 1,
    ...
    // Change Password Mock Data
    accountForChangePassword: {
        id: 9,
        version: 1,
        email: 'changepass@gmail.com',
        password: '123456', // Plain password for bcrypt mock comparison
        enableTotp: false,
        enableEmailOtp: false,
        isCredential: true,
        isActive: true,
